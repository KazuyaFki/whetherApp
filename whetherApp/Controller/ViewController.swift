...
//  whetherApp
//
//  Created by Kazuya Fukui on 2020/05/29.
...
class ViewController: UIViewController {
    ...
    func getAPI(){
           ...
           let url = "http://weather.livedoor.com/forecast/webservice/json/v1?city=290010"
    ...
    @IBAction func kyotoTap(_ sender: Any) {
    
        performSegue(withIdentifier: "kyoto", sender: nil)
